    ...
    return (
        <div className="Footer">
            <div className="Footer-donations">
                IronRadio is moving donations over to <a className="Footer-donations-link" href="https://www.patreon.com/" target="_blank">Patreon</a>. Keep an eye on the site and podcast for details if you'd like to become a donor.<br /><br />Each month, for less than the bloody bank sneaks out of your account in fees, you can help support a subculture of hardcore but intellectual guys (and a few gals) that know brains and brawn are not opposites! We are the un-manipulated, cheese-free "public radio" of sports nutrition, bodybuilding, and powerlifting - thanks to YOU!
            ...
            <p className="Footer-text">
                ...
                </svg> Web site developed by <a className="Footer-link" href="https://github.com/jmcginty15/" target="_blank">Jason McGinty</a> using <a className="Footer-link" href="https://create-react-app.dev/" target="_blank">create-react-app</a><br />
            </p>
        </div>
    )
}
