    ...
    return (
        <div className="Footer">
            <div className="Footer-donations">
                IronRadio is moving donations over to <a className="Footer-donations-link" href="https://www.patreon.com/" target="_blank">Patreon</a>.
            ...
            <p className="Footer-text">
                Unless specifically stated, contents <i class="fa fa-copyright" aria-hidden="true" /> copyright
            ...
            <p className="Footer-text">
                ...
                </svg> Site developed by <a className="Footer-link" href="https://github.com/jmcginty15/" target="_blank">Jason McGinty</a> using <a className="Footer-link" href="https://create-react-app.dev/" target="_blank">create-react-app</a>.
                Get in touch <a className="Footer-link" href="https://jasonmcginty.surge.sh/" target="_blank">here</a> for all your small business web development needs.
            </p>
        </div>
    )
}
