    ...
    return (
        <div className="Footer">
            <div className="Footer-donations">
                Iron Radio is moving donations over to <a className="Footer-donations-link" href="https://www.patreon.com/" target="_blank">Patreon</a>. Keep an eye on the site and podcast for details if you'd like to become a donor.<br /><br />Each month, for less than the bloody bank sneaks out of your account in fees, you can help support a subculture of hardcore but intellectual guys (and a few gals) that know brains and brawn are not opposites! We are the un-manipulated, cheese-free "public radio" of sports nutrition, bodybuilding, and powerlifting - thanks to YOU!
            ...
            <p className="Footer-text">Unless specifically stated, contents <i class="fa fa-copyright" aria-hidden="true" /> copyright N.E.W. Associates, Inc. 2001-2021. Site maintained by Phil Stevens exclusively as President of N.E.W. Associates. All content is for informational purposes only. Use of the Iron Radio <i class="fa fa-copyright" aria-hidden="true" /> and Nutrition Radio <i class="fa fa-copyright" aria-hidden="true" /> icons and links to free audio content is free for use on other Internet sites, providing the audio or icon is not altered in any way, and we have the requester's email on file. Content is roughly PG-13 in nature.</p>
            ...
            <p className="Footer-text">
                ...
                </svg> Site developed by <a className="Footer-link" href="https://github.com/jmcginty15/" target="_blank">Jason McGinty</a> using <a className="Footer-link" href="https://create-react-app.dev/" target="_blank">create-react-app</a>. Get in touch <a className="Footer-link" href="https://jasonmcginty.surge.sh/" target="_blank">here</a> for all your small business web development needs.
            </p>
        </div>
    )
}
